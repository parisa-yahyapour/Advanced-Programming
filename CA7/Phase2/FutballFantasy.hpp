...
private:
    ...
    std ::vector<std ::string> seperated_name_price_player(std ::string column_data);
    void save_team_players_presence(std :: pair<std :: shared_ptr<RealTeam>,std :: shared_ptr<RealTeam>> team1_team2,const std:: vector<std ::string>& columns, int num_week);
    void save_goals_goals_assist(std :: pair<std :: shared_ptr<RealTeam>,std :: shared_ptr<RealTeam>> team1_team2, std :: string goals_info, int num_week);
    void apply_effect_win_lose_equal(std :: pair<std :: shared_ptr<RealTeam>,std :: shared_ptr<RealTeam>> team1_team2,std ::pair<int, int> goal_team1_team2, int num_week);
    void calculate_players_score(std :: pair<std :: shared_ptr<RealTeam>,std :: shared_ptr<RealTeam>> team1_team2,std ::pair<int, int> goal_team1_team2, int num_week);
    void set_captian(const std :: vector<std :: string>& inputs);
    std :: string assign_set_captain_values(std :: string& name, const std :: vector<std :: string> inputs);
    void show_budget(const std :: vector<std :: string>& inputs);
